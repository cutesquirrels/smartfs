// Copied from https://github.com/sentientwaffle/feed-read/blob/master/index.js on Mar 24, 2014, 6 PM UTC.
// Original license: MIT style, https://github.com/sentientwaffle/feed-read/blob/master/LICENSE
// -- cutesquirrels
...
FeedRead.atom = function(xml, source, callback) {
  ...
  parser.onclosetag = function(tagname, current_tag) {
    ...
    } else if (tagname == "id" && !current_tag.parent.parent) {
      meta.guid = current_tag.children[0];
    }
  };
